...
export const DEFAULT_GIFT_TO_ACTION: Record<string, TikTriggerAction> = {
  ...
  chicken: "chicken",
  "!chicken": "chicken",
  "Flame scientist": "scientistflame",
  FlameScientist: "scientistflame",
  scientistflame: "scientistflame",
  "!scientistflame": "scientistflame",
  "Pistol ammo": "pistolammo50",
...
> = {
  ...
  scientistflame: {
    ...
    description:
      "Spawn a heavy scientist near the streamer and force a flamethrower (handmade first, military fallback) with fuel. Scrap from the webhook is capped at 10 for spawn actions.",
  ...
  tiger: {
    label: "Tiger",
    description:
      "Spawn 1 tiger near streamer; also gives semi-auto pistol + 10 pistol ammo on belt. Set TigerPrefabPath in RustChaos.json if spawn fails on your build.",
    exampleGifts: ["Tiger"],
  },
  panther: {
    label: "Panther",
  ...
  chicken: {
    label: "Chicken",
    description: "Spawn a chicken near the streamer (animal prefab candidates). Scrap from webhook capped at 10 with other solo spawns.",
    exampleGifts: ["Chicken", "chicken"],
  },
  supply: {
    label: "Supply",
  ...
  healinghands: {
    label: "Healing Hands",
    description:
      "Heals the streamer +10 health per trigger (configurable on server); if already at full health, gives 1 bandage, 1 pistol bullet, or 1 meat at random. In-game chat always shows the viewer who gave it and the streamer name.",
...
const EVENT_TO_ACTION: Record<string, TikTriggerAction> = {
  ...
  scientist: "scientist",
  scientistflame: "scientistflame",
  flame: "scientistflame",
  flamethrower: "scientistflame",
  chicken: "chicken",
  test: "test",
  chaos: "chaos",
  scientistboat: "scientistboat",
